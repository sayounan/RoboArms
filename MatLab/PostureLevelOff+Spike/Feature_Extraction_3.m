...
for p = 1:11
    ...
    EMG_Feat_Val.(Names{p}).posture.Time = linspace(0,(Size/Fs),NumBins);
    ...
    EMG_Feat_Val.(Names{p}).posture.Data = Features;
end

figure(1)
subplot(4,1,1)
plot(EMG_Feat_Val.HC.posture.Time,EMG_Feat_Val.HC.posture.Data(1,:),EMG_Feat_Val.HC.posture.Time,EMG_Feat_Val.HC.posture.Data(25,:))
title('Features Hand Closed: EMG1 & EMG 7');
ylabel('MAV')
subplot(4,1,2)
plot(EMG_Feat_Val.HC.posture.Time,EMG_Feat_Val.HC.posture.Data(2,:),EMG_Feat_Val.HC.posture.Time,EMG_Feat_Val.HC.posture.Data(26,:))
ylabel('ZC')
subplot(4,1,3)
plot(EMG_Feat_Val.HC.posture.Time,EMG_Feat_Val.HC.posture.Data(3,:),EMG_Feat_Val.HC.posture.Time,EMG_Feat_Val.HC.posture.Data(27,:))
ylabel('SSC')
subplot(4,1,4)
plot(EMG_Feat_Val.HC.posture.Time,EMG_Feat_Val.HC.posture.Data(4,:),EMG_Feat_Val.HC.posture.Time,EMG_Feat_Val.HC.posture.Data(28,:))
ylabel('WL')
