...
for i=1:11
    % Class scatter matrix for each posture, summed together for the Within
    % Class Scatter
...
load EMG_Features_Validation29.mat
...
H = heatmap(classes, classes, Perc);
